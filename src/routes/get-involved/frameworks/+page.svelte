...
<script>
  ...
  import enFallback from '$lib/i18n/en/frameworks.json';
  ...
  async function loadMarkdownContent(loc) {
    ...
    try {
      const module = await import(`$lib/content/get-involved/frameworks/${loc}/frameworks-guide.md`);
      ...
      try {
        ...
        console.error('Failed to load framework development guide:', e2);
        loadError = true;
      }
    }
    ...
    <div class="bottom-cta">
      <div class="cta-content">
        ...
        <div class="cta-actions">
          ...
          <a href="{base}/frameworks" class="primary-btn large secondary">
            {getText('browseFrameworks')}
          </a>
        </div>
      </div>
    </div>
