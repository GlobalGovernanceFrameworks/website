...
<script>
  ...
  import enFallback from '$lib/i18n/en/translations.json';
  ...
  async function loadMarkdownContent(loc) {
    ...
    try {
      const module = await import(`$lib/content/get-involved/translations/${loc}/translation-guide.md`);
      ...
      try {
        ...
        console.error('Failed to load translation guide:', e2);
        loadError = true;
      }
    }
