// src/routes/resources/whitepapers/model-evaluation/+page.js
...
export async function load({ params, depends, url }) {
  ...
  console.log('Loading Model Evaluation with locale:', currentLocale);
  ...
  try {
    ...
    try {
      ...
      currentUrl = `https://www.globalgovernanceframeworks.org/resources/whitepapers/model-evaluation`;
    }
    ...
    console.error('Error loading Model Evaluation:', e);
    
    throw error(404, {
      message: `Model Evaluation content not available`,
      details: {
        locale: currentLocale,
