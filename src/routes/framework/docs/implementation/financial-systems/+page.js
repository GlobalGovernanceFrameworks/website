// src/routes/framework/docs/implementation/financial-systems/+page.js
...
export async function load({ depends, url }) {
  ...
  try {
    ...
    for (const section of sections) {
      try {
        ...
        content[section] = await import(`$lib/content/framework/${currentLocale}/implementation/financial-systems/${section}.md`);
        isModular = true;
      } catch (e) {
        // Fall back to English if translation isn't available
        try {
          content[section] = await import(`$lib/content/framework/en/implementation/financial-systems/${section}.md`);
          isModular = true;
        } catch (e2) {
    ...
    for (const tool of tools) {
      try {
        // Try to load the current locale version
        toolsContent[tool] = await import(`$lib/content/framework/${currentLocale}/tools/financial-systems/${tool}.md`);
      } catch (e) {
        // Fall back to English if translation isn't available
        try {
          toolsContent[tool] = await import(`$lib/content/framework/en/tools/financial-systems/${tool}.md`);
        } catch (e2) {
  ...
  if (!isModular) {
    try {
      legacyContent = await import(`$lib/content/framework/${currentLocale}/implementation/financial-systems.md`);
    } catch (e) {
      try {
        legacyContent = await import(`$lib/content/framework/en/implementation/financial-systems.md`);
      } catch (e2) {
