// src/routes/framework/docs/implementation/animal-welfare/+page.js
...
export async function load({ depends, url }) {
  ...
  try {
    ...
    for (const section of sections) {
      try {
        ...
        content[section] = await import(`$lib/content/framework/${currentLocale}/implementation/animal-welfare/${section}.md`);
        isModular = true;
      } catch (e) {
        // Fall back to English if translation isn't available
        try {
          content[section] = await import(`$lib/content/framework/en/implementation/animal-welfare/${section}.md`);
          isModular = true;
        } catch (e2) {
  ...
  if (!isModular) {
    try {
      legacyContent = await import(`$lib/content/framework/${currentLocale}/implementation/animal-welfare.md`);
    } catch (e) {
      try {
        legacyContent = await import(`$lib/content/framework/en/implementation/animal-welfare.md`);
      } catch (e2) {
