<!-- src/routes/framework/tools/spiritual/multimedia-resource-library/+page.svelte -->
<script>
...
<div class="container">
  <div class="back-navigation">
    <a href="{base}/framework/tools/spiritual" class="back-link">
  ...
  <div class="container">
    <div class="content-wrapper">
      ...
      <div class="looking-for-card">
        ...
        <a href="{base}/framework/tools/spiritual" class="primary-btn">{texts.backToToolsButton}</a>
      </div>
      
      <!-- Back to Tools Overview link -->
      <div class="back-link-bottom">
        <a href="{base}/framework/tools/spiritual">
          <span class="back-icon">←</span>
          {texts.backToTools}
        </a>
      </div>
