// src/routes/framework/tools/ethics/[tool]/+page.js
...
export async function load({ params, depends }) {
  ...
  try {
    ...
    component = await import(`$lib/content/framework/${currentLocale}/implementation/ethics/tools/digital-tools/${tool}.md`);
  } catch (e) {
    // Fall back to English if translation isn't available
    try {
      component = await import(`$lib/content/framework/en/implementation/ethics/tools/digital-tools/${tool}.md`);
    } catch (e) {
