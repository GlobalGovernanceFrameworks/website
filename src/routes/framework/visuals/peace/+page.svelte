<!-- src/routes/framework/visuals/peace/+page.svelte -->
<script>
  ...
  function getVisualizationPath(id, format, forInteractive = false) {
    ...
    if (forInteractive) {
      return `${base}/framework/visuals/peace/technical/${id}`;
    }
    
    // Special case for Spiral Dynamics HTML file
    if (id === 'spiral-dynamics' && format === 'html') {
      return `/images/framework/peace/spiral-dynamics-${currentLocale}.html`;
    }
    ...
    return `${base}/images/framework/peace/${id}${langSuffix}.${format}`;
  }
</script>
...
<section class="main-content">
  <div class="container">
    <div class="content-wrapper">
          ...
          <div class="visual-card {visual.color}">
            <div class="visual-preview">
              {#if visual.format === 'html'}
                <img src={`${base}/images/framework/peace/${visual.id}-preview.png`} alt={texts[`${visualNameToTranslationKey[visual.id]}Title`]} />
              {:else}
                <img src={getVisualizationPath(visual.id, visual.format)} alt={texts[`${visualNameToTranslationKey[visual.id]}Title`]} />
              {/if}
            </div>
      ...
      <div class="back-link">
        <a href="{base}/framework/docs/implementation/peace">
