...
**Scope Boundary with Digital Commons Framework**: This framework governs the foundational rules for data — as a resource, as a right, and as a fiduciary trust. It does not govern the collaborative stewardship of *knowledge* — the meaning-bearing, context-dependent, contestable layer that sits above data. The **Digital Commons Framework** (Tier 3, Cultural & Knowledge Commons) governs how shared knowledge is curated, versioned, contested, preserved, and retired within the GGF ecosystem. The Aurora Accord provides the Digital Commons with its data governance substrate; the Digital Commons builds knowledge commons infrastructure on that foundation. The boundary is: if the question is "who may access this and under what consent conditions?" — that is Aurora Accord territory. If the question is "how should this knowledge be understood, preserved, challenged, or allowed to evolve?" — that is Digital Commons territory.
...
| **Digital Commons Framework** | The Aurora Accord governs *data* — its sovereignty, portability, fiduciary handling, and the rights attached to data as a category. The Digital Commons Framework governs *knowledge* — the social and institutional processes by which data becomes meaning, meaning becomes transmissible, and transmission becomes collective inheritance. The Aurora Accord provides the Digital Commons with consent infrastructure, the Digital Justice Tribunal for enforcement, the GGF Minimum Viable Security Stack for technical hosting, and the three-fold data classification (personal, community, public) that the Digital Commons implements within its knowledge stewardship protocols. Where both frameworks apply — for instance, a dataset that is also Traditional Knowledge — the Aurora Accord handles sovereignty classification and consent, while the Digital Commons handles access governance, stewardship licensing, and epistemic conflict resolution. |
