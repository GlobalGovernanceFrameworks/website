...
- **Version History**:
  - **3.1 (2026-03-10)**: Added Slow-Variable Constraint to adaptive governance mandate. Replaced mandate paragraph in §5.3
...
- **Conversion Table**:
  ...
  | Fiat Donations     | 1:1 match via *Heartstarter* (see AUBI Framework §7.4 and Financial Systems §4.3 for reserve mechanics and per-BAZ ceiling) |
...
**Change Management:** Global standard changes that affect BAZ-level economic operations follow the Notice and Adaptive Response Protocol (NARP) defined in Financial Systems §14.3. BAZ Councils have standing to submit formal endorsements or objections during the 90-day notice window for any Tier B structural change. The 30% objection threshold applies to active BAZs as defined in §14.3. BAZ Councils may also petition for Tier B reclassification of proposed Tier A changes within 30 days of announcement.
**Slow-Variable Constraint:** Revisions to cross-BAZ ecological exchange standards (carbon budget linkages to Leaves rewards, Inter-Currency Translation Layer ecological multipliers) qualify as SVDCs under the AUBI Framework §4.3 and require LEKH quorum before the Social Resilience Council may implement them. BAZ councils may flag a pending inter-BAZ ecological standard as SVDC-qualifying; the Earth Council adjudicates disputed classifications within 30 days.
