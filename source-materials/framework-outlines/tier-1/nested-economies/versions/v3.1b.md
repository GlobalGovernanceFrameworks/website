...
- **Approach**: Distinct from EU’s centralized regulations, WTO’s trade focus, degrowth’s anti-growth stance, and doughnut economics’ static boundaries, it integrates a single **Hearts** currency for universal value recognition, a parallel **Love Ledger** for informal contribution tracking, and coordination with the four-layered **Adaptive Universal Basic Income (AUBI)** system for resource justice.
...
- **Key Features**: Single **Hearts** currency with **Leaves** as AUBI-defined ecological tokens, **Love Ledger** for informal contribution tracking, ethical trade zones, AUBI integration, simplified two-tier governance via **BAZ Councils** and the **Social Resilience Council**.
...
- **Revision**: 3.1 (2026-03-10)
- **Version History**:
  - **3.1 (2026-03-10)**: Added Slow-Variable Constraint to adaptive governance mandate. Replaced mandate paragraph in §5.3. Aligned outline with drafted framework: single Hearts currency (repositioned Leaves as AUBI-defined ecological tokens rather than co-equal currency), two-tier governance model, fixed Global Commons Council → Social Resilience Council.
  - **3.0 (2025-09-03)**: Established Hearts as single universal currency (Leaves retained as AUBI ecological tokens); clarified unique role as economic subsidiarity framework; adopted two-tier governance (BAZ Councils + Social Resilience Council); removed redundant AUBI details with cross-references; separated Love Ledger from Hearts mechanisms; updated Quick Start Guide to BAZ Starter Pack.
...
- **Distinctions**:
  ...
  - *Vs. Degrowth*: Supports regenerative growth via **Hearts** currency rewarding care and restoration.
...
- **Key Principles** (color-coded):
  ...
  - <span style="color: red;">Resource Justice</span>: Equitable access via the **AUBI Framework**, **Hearts** currency, and **Leaves** ecological tokens.
...
- **Local**: Community-driven care economies using **Hearts** currency, with informal care contributions recognized by the parallel **Love Ledger** system. This level involves chartered **Community Providers** delivering formal services redeemable for **Hearts**, supported by **Community Weavers** for on-the-ground facilitation, and stabilized by the **Hearts Treasury** (`mechanism_hearts_treasury`).
- **Regional**: Voluntary bioregional cooperation through standardized **Hearts** exchange protocols and 10% solidarity redistribution, without intermediate governance layers.
- **Global**: **Social Resilience Council** maintains Hearts currency standards, crisis response coordination, and technology commons governance, with **Earth Council** veto authority on decisions affecting Indigenous sovereignty.
- **Governance Note**: The framework operates through a simplified **two-tier system** (local BAZ Councils + global Social Resilience Council), eliminating complex intermediate bioregional governance.
...
- **Example**: **Hearts** wallet app syncing with regional **Love Ledger** nodes, converting Green Job Score contributions to **Leaves** ecological tokens.
- **Conversion Table**:
...
- **Economic-Environmental**: Carbon budgets linked to **Leaves** rewards (AUBI ecological tokens).
...
## 10. Appendices
- **Glossary**: **Hearts**, **Leaves** (AUBI ecological tokens), **Love Ledger**, **Proof of Care**, **LMCI**, **Right Relationship**, **Social Resilience Council**, **Earth Council**, **BAZ**, **Community Providers**, **Community Weavers**, **Inter-Currency Translation Layer**, AUBI.
...
- **Financial Systems Architecture**: Overview of **Hearts** currency, **Leaves** ecological tokens, **Love Ledger**, **Proof of Care**, and BAZ treasury management.
- **Visual Index**:
...
**Revision Notes**:
- **3.1 (2026-03-10)**: Added Slow-Variable Constraint to adaptive governance mandate (§5.3). Aligned outline with drafted framework: single Hearts currency (repositioned Leaves as AUBI-defined ecological tokens rather than co-equal currency), two-tier governance model, fixed Global Commons Council → Social Resilience Council.
- **3.0 (2025-09-03)**: Established Hearts as single universal currency (Leaves retained as AUBI ecological tokens); clarified unique role as economic subsidiarity framework; adopted two-tier governance (BAZ Councils + Social Resilience Council); removed redundant AUBI details with cross-references; separated Love Ledger from Hearts mechanisms; updated Quick Start Guide to BAZ Starter Pack.
